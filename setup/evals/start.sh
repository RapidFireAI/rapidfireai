...
# RapidFire AI Multi-Service Startup Script - EVALS MODE
...
show_status() {
    print_status "RapidFire AI Services Status (EVALS MODE):"
    echo "=================================="
    ...
    if [[ "$RF_COLAB_MODE" == "true" ]]; then
        print_success "RapidFire running in Colab mode (EVALS)!"
        ...
        print_success "RapidFire Frontend is ready (EVALS MODE)!"
...
# Main execution
main() {
    print_status "Starting RapidFire AI services (EVALS MODE)..."
