...
# This script starts MLflow server, Evals Dispatcher, and frontend tracking server
...
show_status() {
    ...
    if [[ "$RF_COLAB_MODE" == "true" ]]; then
        ...
        print_success "RapidFire Evals Dashboard is ready!"
