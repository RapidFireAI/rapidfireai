...
def install_packages(evals: bool = False):
    ...
    if evals and not is_colab and cuda_major == 12:
        ...
        packages.append({"package": "torch==2.9.0", "extra_args": ["--upgrade", "--index-url", "https://download.pytorch.org/whl/cu126"]})
        packages.append({"package": "torchvision==0.24.0", "extra_args": ["--upgrade", "--index-url", "https://download.pytorch.org/whl/cu126"]})
        packages.append({"package": "torchaudio==2.9.0", "extra_args": ["--upgrade", "--index-url", "https://download.pytorch.org/whl/cu126"]})
