...
from rapidfireai.infer.db.db_interface import DatabaseInterface
from rapidfireai.infer.utils.constants import ContextStatus, ExperimentStatus, PipelineStatus, TaskStatus
...
class RFDatabase:
    ...
    def create_pipeline(
        ...
        Args:
            ...
            model_config_json: JSON string of model configuration
            sampling_params_json: JSON string of sampling parameters
        ...
        INSERT INTO pipelines (
            context_id, pipeline_name, pipeline_type,
            model_config_json, sampling_params_json, status, error,
    ...
    def set_pipeline_progress(self, pipeline_id: int) -> dict[str, Any] | None:
        ...
        """
        query = """
        SELECT pipeline_id, context_id, pipeline_name, pipeline_type,
               model_config_json, sampling_params_json, status, current_shard_id,
        ...
        if result:
            ...
            return {
                ...
                "pipeline_name": row[2],
                "pipeline_type": row[3],
                "model_config_json": row[4],
                "sampling_params_json": row[5],
                "status": row[6],
    ...
    def create_ic_operation(
        ...
        """
        from rapidfireai.infer.utils.constants import ICStatus
