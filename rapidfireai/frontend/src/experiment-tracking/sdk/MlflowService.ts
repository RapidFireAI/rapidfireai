...
export const config = {
  apiBaseUrl: 'http://127.0.0.1:9047',
};
...
export class MlflowService {
  ...
  static searchExperiments = (data: any) => {
    return getBigIntJson({ 
      url: '/ajax-api/2.0/mlflow/experiments/search',
      data 
    }).then(transformSearchExperimentsResponse);
  };
  ...
  static getExperiment = (data: any) =>
    getBigIntJson({ url: 'ajax-api/2.0/mlflow/experiments/get', data }).then(transformGetExperimentResponse);

  /**
   * Get mlflow experiment by name
   */
  static getExperimentByName = (data: any) =>
    getBigIntJson({ url: 'ajax-api/2.0/mlflow/experiments/get-by-name', data }).then(
      transformGetExperimentResponse,
    );
  ...
  static getRun = (data: any) =>
    getBigIntJson({ url: 'ajax-api/2.0/mlflow/runs/get', data }).then(transformGetRunResponse);
   ...
   */
  static listArtifacts = (data: any) => getBigIntJson({ url: 'ajax-api/2.0/mlflow/artifacts/list', data });

  /**
   * Get metric history
   */
  static getMetricHistory = (data: any) =>
    getBigIntJson({ url: 'ajax-api/2.0/mlflow/metrics/get-history', data });
