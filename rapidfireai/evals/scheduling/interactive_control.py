...
class InteractiveControlHandler:
    ...
    def _handle_clone(
        ...
        # Extract display metadata using shared utility
        display_metadata = extract_pipeline_display_metadata(pipeline_config)
        model_name = display_metadata.pop("model_name", "Unknown")
