...
check("missing file,    run_evals (should allow)", None, "evals", should_pass=True)
check("missing file,    run_fit   (should block)", None, "fit", should_pass=False)
check("empty file,      run_fit   (should block)", "", "fit", should_pass=False)
check("empty file,      run_evals (should block)", "", "evals", should_pass=False)
